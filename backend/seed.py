...
CATALOG: list[tuple[str, str, str, dict]] = [
    ...
    (
        ...
        "Chest",
        "Barbell",
        {"width": "Close", "base": "Bench Press"},
    ),
    (
        "Incline Bench Press (Wide Grip)",
        "Chest",
        "Barbell",
        {"width": "Wide", "base": "Bench Press"},
    ),
    ...
    ("Smith Machine Incline Press", "Chest", "Smith Machine", {"base": "Bench Press"}),
    (
    ...
    ("Smith Machine Decline Press", "Chest", "Smith Machine", {"base": "Bench Press"}),
    (
    ...
    ("Decline Machine Chest Press", "Chest", "Machine", {"base": "Machine Chest Press"}),
